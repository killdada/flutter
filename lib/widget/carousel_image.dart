...
class CarouselState extends State<Carousel> {
  ...
  @override
  void initState() {
    // EventBus().on(JumpCarouselPageWithIndex + widget.id.toString(),
    //     (pageIndex) {
    //   // do something
    //   print('JumpCarouselPageWithIndex:$pageIndex');
  ...
  Widget build(BuildContext context) {
    ...
    if (_currentImageIndex != widget.curImagePage &&
        widget.curImagePage > 0 &&
        widget.curImagePage < widget.images.length - 1) {
      _currentImageIndex = widget.curImagePage;
//      _controller.jumpToPage(widget.curImagePage);
    }
    return Stack(
      children: <Widget>[
        Container(
